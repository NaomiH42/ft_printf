...
/*   Updated: 2023/01/22 00:16:21 by ehasalu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t	hexalowlen(unsigned int nbr)
{
	size_t	len;
...
void	hexalowprint(unsigned int nbr, char *flags)
{
	if (nbr >= 16)
	{
...
size_t	hexalow(unsigned int n, char *flags)
{
	int	after;
	int	before;
	int	dots;
